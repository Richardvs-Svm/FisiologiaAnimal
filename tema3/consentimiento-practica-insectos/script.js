const CONFIG = {
  ...
  appsScriptUrl: "https://script.google.com/macros/s/AKfycbxx9Ld5ILnlfWbNv_lBdUevvjg5MvFImmjKxpmC-2uPmQAejVf_5rl7lb0Smv-cSCiDJw/exec",
};
...
form.addEventListener("submit", (event) => {
  ...
  submitButton.querySelector("span:first-child").textContent = "Abriendo confirmación…";

  // The native POST continues after this handler and opens Apps Script in a
  // new tab. There is deliberately no fetch request and therefore no CORS.
  window.setTimeout(() => {
    form.hidden = true;
